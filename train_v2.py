...
class ModelArguments:
    ...
    neg_prompt_sentence_template: str = field(
...
def main():
    ...
    def prepare_features(examples):
        ...
        if sent2_cname is not None:
            ...
            for key in sent_features:
                features[key] = [[sent_features[key][i], sent_features[key][i + total], neg_sent_features[key][i]]
    ...
    if model_args.mask_embedding_sentence:
        ...
        print('template mask_embedding_template', tokenizer.decode(model.neg_mask_embedding_template))
